...
##
##   Http:
##   - http.make_http_get(endpoint, headers, body)
##   - http.make_http_post(endpoint, headers, body)
##   - http.make_http_put(endpoint, headers, body)
##   - http.make_http_delete(endpoint, headers, body)
##   - http.make_http_request(endpoint, headers, method, body)
##
##	 Auth:
...
##
##	 Data:
##   - data.make_graphql_query()
##   - data.make_graphql_mutation()
